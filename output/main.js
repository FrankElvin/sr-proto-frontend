...
var $author$project$AllReports$Model = F4(
	function (data, filteredData, searchFilter, statusText) {
		return {data: data, filteredData: filteredData, searchFilter: searchFilter, statusText: statusText};
	});
var $krisajenkins$remotedata$RemoteData$NotAsked = {$: 'NotAsked'};
var $author$project$AllReports$LoadReport = function (a) {
	return {$: 'LoadReport', a: a};
};
...
var $author$project$ReportApi$Query$getAllReports = function (object____) {
	return A4(
...
var $author$project$AllReports$CompanyReport = F3(
	function (reportId, companyName, companyBalance) {
		return {companyBalance: companyBalance, companyName: companyName, reportId: reportId};
	});
...
var $author$project$ReportApi$Object$CompanyReport$companyBalance = A4(
...
var $author$project$ReportApi$Object$CompanyReport$companyName = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'(Maybe String)',
	'companyName',
	_List_Nil,
...
var $author$project$ReportApi$Scalar$Id = function (a) {
	return {$: 'Id', a: a};
};
...
var $author$project$ReportApi$Scalar$defaultCodecs = {
	codecId: {
		decoder: A2($elm$json$Json$Decode$map, $author$project$ReportApi$Scalar$Id, $dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$scalarDecoder),
...
var $author$project$ReportApi$Scalar$Codecs = function (a) {
	return {$: 'Codecs', a: a};
};
var $author$project$ReportApi$Scalar$defineCodecs = function (definitions) {
	return $author$project$ReportApi$Scalar$Codecs(definitions);
};
var $author$project$ReportApi$ScalarCodecs$codecs = $author$project$ReportApi$Scalar$defineCodecs(
	{codecId: $author$project$ReportApi$Scalar$defaultCodecs.codecId});
var $author$project$ReportApi$Scalar$unwrapCodecs = function (_v0) {
	var unwrappedCodecs = _v0.a;
	return unwrappedCodecs;
};
var $author$project$ReportApi$Object$CompanyReport$reportId = A4(
	$dillonkearns$elm_graphql$Graphql$Internal$Builder$Object$selectionForField,
	'ScalarCodecs.Id',
	'reportId',
	_List_Nil,
	$author$project$ReportApi$Scalar$unwrapCodecs($author$project$ReportApi$ScalarCodecs$codecs).codecId.decoder);
var $author$project$AllReports$reportSelection = A4($dillonkearns$elm_graphql$Graphql$SelectionSet$map3, $author$project$AllReports$CompanyReport, $author$project$ReportApi$Object$CompanyReport$reportId, $author$project$ReportApi$Object$CompanyReport$companyName, $author$project$ReportApi$Object$CompanyReport$companyBalance);
var $author$project$AllReports$reportQuery = $author$project$ReportApi$Query$getAllReports($author$project$AllReports$reportSelection);
...
var $author$project$AllReports$makeRequest = A2(
	$dillonkearns$elm_graphql$Graphql$Http$send,
	A2($elm$core$Basics$composeR, $krisajenkins$remotedata$RemoteData$fromResult, $author$project$AllReports$LoadReport),
	A2($dillonkearns$elm_graphql$Graphql$Http$queryRequest, 'http://localhost:8080/graphql', $author$project$AllReports$reportQuery));
var $author$project$AllReports$init = function (_v0) {
	return _Utils_Tuple2(
		A4($author$project$AllReports$Model, $krisajenkins$remotedata$RemoteData$NotAsked, _List_Nil, '', $elm$core$Maybe$Nothing),
		$author$project$AllReports$makeRequest);
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$AllReports$subscriptions = function (_v0) {
...
var $author$project$AllReports$isMatchingFilter = F2(
	function (filter, report) {
		if (report.$ === 'Nothing') {
			return false;
		} else {
			var someReport = report.a;
			var _v1 = someReport.companyName;
			if (_v1.$ === 'Nothing') {
				return false;
			} else {
				var name = _v1.a;
				return A2($elm$core$String$startsWith, filter, name) ? true : false;
			}
		}
	});
var $author$project$AllReports$unpackRequestResult = function (maybeReports) {
	if (maybeReports.$ === 'Nothing') {
		return _List_Nil;
	} else {
		var reports = maybeReports.a;
		return reports;
	}
};
var $author$project$AllReports$filterModelData = F3(
	function (responseModel, filter, currentData) {
		switch (responseModel.$) {
			...
			case 'Failure':
				return currentData;
			default:
				var reports = responseModel.a;
				return A2(
					$elm$core$List$filter,
					$author$project$AllReports$isMatchingFilter(filter),
					$author$project$AllReports$unpackRequestResult(reports));
		}
	});
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $author$project$AllReports$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 'StartSearch':
				return _Utils_Tuple2(model, $author$project$AllReports$makeRequest);
			case 'FilterData':
				var filter = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							filteredData: A3($author$project$AllReports$filterModelData, model.data, filter, model.filteredData),
							searchFilter: filter
						}),
					$elm$core$Platform$Cmd$none);
			default:
				var responseModel = msg.a;
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							data: responseModel,
							filteredData: A3($author$project$AllReports$filterModelData, responseModel, model.searchFilter, model.filteredData)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$AllReports$Document = F2(
	function (title, body) {
		return {body: body, title: title};
	});
var $author$project$AllReports$FilterData = function (a) {
	return {$: 'FilterData', a: a};
};
var $author$project$AllReports$StartSearch = {$: 'StartSearch'};
...
var $author$project$AllReports$reportToRow = function (maybeReport) {
	if (maybeReport.$ === 'Nothing') {
		return A2($elm$html$Html$div, _List_Nil, _List_Nil);
	} else {
		var someReport = maybeReport.a;
		return A2(
			$elm$html$Html$tr,
			_List_Nil,
			_List_fromArray(
				[
					...
					_List_fromArray(
						[
							$elm$html$Html$text(
							A2($elm$core$Maybe$withDefault, '<missing>', someReport.companyName))
						])),
					A2(
					$elm$html$Html$td,
					_List_Nil,
					_List_fromArray(
						[
							...
							A2(
								...
								2,
								A2($elm$core$Maybe$withDefault, 0.0, someReport.companyBalance)))
						]))
				]));
	}
};
...
var $author$project$AllReports$reportTable = function (maybeReports) {
	return _Utils_eq(maybeReports, _List_Nil) ? A2($elm$html$Html$div, _List_Nil, _List_Nil) : A2(
		$elm$html$Html$table,
		_List_fromArray(
			[
				$elm$html$Html$Attributes$class('table is-bordered is-striped is-fullwidth')
			]),
		$elm$core$List$concat(
			_List_fromArray(
				[
					...
					[
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Company Balance')
									]))
							]))
					]),
					A2($elm$core$List$map, $author$project$AllReports$reportToRow, maybeReports)
				])));
};
var $elm$html$Html$section = _VirtualDom_node('section');
var $author$project$AllReports$statusTextBar = function (model) {
	var _v0 = model.data;
	switch (_v0.$) {
		case 'NotAsked':
			return A2($elm$html$Html$div, _List_Nil, _List_Nil);
		...
		case 'Failure':
			return A2(
				...
				_List_fromArray(
					[
						$elm$html$Html$text('Failed to load reports')
					]));
		default:
			return A2($elm$html$Html$div, _List_Nil, _List_Nil);
	}
...
var $author$project$AllReports$view = function (model) {
	return A2(
		$author$project$AllReports$Document,
		'SR Proto Report Viewer',
		_List_fromArray(
			[
				A2(
				$elm$html$Html$nav,
				_List_fromArray(
					[
						$elm$html$Html$Attributes$class('breadcrumb is-centered is-large')
					]),
				_List_fromArray(
					[
						A2(
						...
						_List_fromArray(
							[
								...
								_List_fromArray(
									[
										$elm$html$Html$text('Report Viewer')
									]))
							]))
					])),
				A2(
							...
							[
								...
								_List_fromArray(
									[
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Campaign Report Viewer')
											])),
										A2(
										$elm$html$Html$h2,
										_List_fromArray(
										...
										_List_fromArray(
											[
												$elm$html$Html$text('Download company report data and filter it for analysis.')
											])),
										A2(
										$elm$html$Html$div,
										_List_fromArray(
											...
											[
												...
												_List_fromArray(
													[
														...
														_List_fromArray(
															[
																$elm$html$Html$Attributes$placeholder('Report search filter'),
																$elm$html$Html$Events$onInput($author$project$AllReports$FilterData),
																$elm$html$Html$Attributes$class('input is-info')
															]),
														_List_Nil)
													])),
												A2(
												...
												_List_fromArray(
													[
														$elm$html$Html$Attributes$class('column is-1')
													]),
												_List_fromArray(
													[
														A2(
														...
														_List_fromArray(
															[
																$elm$html$Html$Events$onClick($author$project$AllReports$StartSearch),
																$elm$html$Html$Attributes$class('button is info')
															]),
														_List_fromArray(
															[
																$elm$html$Html$text('Update data')
															]))
													]))
											])),
										$author$project$AllReports$statusTextBar(model)
									]))
							]))
					])),
				A2(
				...
				_List_fromArray(
					[
						...
						_List_fromArray(
							[
								$author$project$AllReports$reportTable(model.filteredData)
							]))
					]))
			]));
};
var $author$project$AllReports$main = $elm$browser$Browser$document(
	{init: $author$project$AllReports$init, subscriptions: $author$project$AllReports$subscriptions, update: $author$project$AllReports$update, view: $author$project$AllReports$view});
_Platform_export({'AllReports':{'init':$author$project$AllReports$main(
